# Generated by Django 3.2.25 on 2025-01-16 21:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vendor_notification', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account_type', models.CharField(blank=True, choices=[('Paypal', 'Paypal'), ('Strip', 'Strip'), ('Nigerian Bank Account', 'Nigerian Bank Account'), ('Indian Bank Account', 'Indian Bank Account')], max_length=50, null=True)),
